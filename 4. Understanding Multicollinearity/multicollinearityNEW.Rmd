...
question("Which statement is true regarding correlation between two measurements?",
         ...
         message = "If the measurements are strongly linearly related, then a linear regression model can be used to represent this association.", allow_retry = TRUE
)
```
...
question("Which of the below statements is correct regarding this true relationship?",
         ...
         message = "This is true since the coefficient in the true model of X1 is 2.", allow_retry = TRUE
)
```
...
question("Which statement is true regarding the three simple linear models?",
         ...
         message = "Option A is correct since the true relationship is (beta_0, beta_1, beta_2, beta_3) = (1, 2, 3, 0)", allow_retry = TRUE
)
```
