...
question("Which of the below statements is correct regarding this true relationship?",
         ...
         answer("In the presence of the other predictors, a one-unit increase in $X_2$ yields a 3-unit increase in $Y$.", message="To interpret a single coefficient in a multiple linear model, we must hold all other predictors constant."),
...
question("Which statement is true regarding the three simple linear models?",
         ...
         answer("In the simple linear model using $X_3$, $X_3$ has no linear association with $Y$.", message = "The relationship may be weak, but it appears nonzero."),
...
question("Which model(s) seem to be estimating the true association of each predictor with the response?",
         ...
         answer("Simple model with $X_3$. ", message = "Remember that the beta coefficients should be beta=c(1, 2, 3, 0)")
)
```
