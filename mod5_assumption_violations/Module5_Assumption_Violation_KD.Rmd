...
In the first plot, note that while the observed hourglass pattern in the residual plot indicates heteroscedasticity, other patterns also indicate the violation e.g. a fanning pattern. In the second plot, we observe that the true relationship in non-linear, and fitting the data to a linear model is inappropriate.
